# Junção Horizontal
Junções Horizontais em que o registro de uma tabela e de outra se complementam, tornando-se um só registro com a quantidade somada de suas colunas, tais como: Cross Join, Inner Join e Outer Join. Para execução dos códigos abaixo execute o [script](https://github.com/marc3lorodrigues/SQLServer/blob/main/Script_MarcaModelo.txt).
